...
> The roles are prefixed with the customer name to make it easier to identify, but in a more streamlined implementation they can just mimic the roles defined at the API level.
